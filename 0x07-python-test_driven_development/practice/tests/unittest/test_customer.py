...
class TestCustomer(unittest.TestCase):
    ...
    """Set up instances of the Customer Class"""
    def setUp(self):
    ...
    def test_customer_fullnames(self):
        """Test for customer full names"""
    ...
    def test_apply_discount(self):
        """Test for apply_discount method"""
